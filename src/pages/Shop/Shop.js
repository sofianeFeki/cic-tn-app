...
const Shop = () => {
  ...
  return (
    <div className=" bg-gray-100 ">
      <Helmet>
        <title>Chemical Ink Company | Shop</title>
        <meta
          name="description"
          content="Découvrez notre large gamme de produits chez Chemical Ink Company. Trouvez des imprimantes, photocopieurs, et fournitures informatiques de qualité en Tunisie."
        />
        <meta
          name="keywords"
        ...
        <meta
          ...
          content="Explorez notre sélection de produits et profitez des meilleures offres disponibles en Tunisie."
        />
        <meta property="og:url" content="https://www.cic-tn.com/shop" />
